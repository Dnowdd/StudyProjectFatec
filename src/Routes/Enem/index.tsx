...
export default function Enem() {
  const Card: React.FC<{ title: string; children: ReactNode }> = ({
    ...
    return (
      <div className="w-full xl:w-1/3 flex flex-col gap-2">
        ...
        <div className="text-justify text-neutral-600">{children}</div>
      </div>
    );
  };
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-24 pb-40">
      ...
      <div className="flex flex-col items-center px-4 xl:px-40 2xl:px-60 gap-10">
        ...
        <div className="flex flex-col xl:flex-row gap-8">
          <Card title="O que é?">
            ...
            O exame é utilizado como uma ferramenta para medir o conhecimento e
            as habilidades adquiridas pelos alunos, além de servir como uma{" "}
            <span className="font-medium">
          ...
          <Card title="Como funciona?">
            ...
            <span className="font-medium">
              ...
              Tecnologias; Ciências da Natureza e suas Tecnologias; e Matemática
              e suas Tecnologias
            </span>
            . Além disso, há uma{" "}
            <span className="font-medium">
